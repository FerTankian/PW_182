...
@section('contenido')
    ...
    <div class="container mt-5" style="margin: 100">
        ...
        <div class="card ">
            ...
            <form method="POST" action="/guardar_recuerdo">
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <p class= "text-danger fdt-italic"> {{$errors->first('txtTitulo')}} </p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <p class= "text-warning fdt-italic"> {{$errors->first('txtRecuerdo')}} </p>
                        </div>
